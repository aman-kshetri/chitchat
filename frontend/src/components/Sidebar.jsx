  ...
  return (
    <div>
        ...
        <div>
            ...
            <input type="text" placeholder='Search user...' className='bg-transparent outline-none text-white placeholder-[#c8c8c8] flex-1' />
        </div>
    </div>
        <div className='flex flex-col'>
            {userDummyData.map((user, index) => (
                <div onClick={() => setSelectedUser(user)} key={user._id} className={`relative flex items-center gap-2 p-2 pl-4 cursor-pointer ${selectedUser?._id === user._id ? 'bg-[#1c28ac]/50' : ''}`}>
